...
The `gov` module enables on-chain governance which allows Hazlor Chain token holder to participate in the decision-making processes. For example, users can:
