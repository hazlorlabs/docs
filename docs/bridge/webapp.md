# From Hazlor Chain (Hazlor Bridge Web App)

## Transfer assets from Hazlor Chain using Hazlor Bridge Web App
...
- Metamask, Keplr, Hazlor.finance DeFi Wallet

#### Coming Soon:

- Ethereum <=> Hazlor [Coming Soon]
...
### How to use the Hazlor Bridge [Web Dapp]

### 1. Connect your wallet

Click the “Connect Wallet’ button to connect your desktop or browser extension wallet. We currently support browser-compatible versions of the Metamask, Keplr, and Hazlor.finance DeFi Wallet.
...
Note: If you are bridging assets from or to Hazlor, you may specify the destination wallet by pasting the address directly or connecting a second wallet to avoid manual errors.
...
If you are transferring from or to Hazlor, you need to specify the destination address by inputting the address manually or connecting a second wallet to receive your funds.
...
After the amount is entered, the bridge network fees will be calculated accordingly. The bridge itself and Hazlor do not charge an additional fee.
...
Both transactions will include an external link to view and monitor the transaction on-chain via scanning utilities such as Hazlor, and Hazlor explorer.
...
Thank you for using the Hazlor bridge and supporting the Hazlor ecosystem!
