...
meta:
  - name: "title"
    content: Hazlor | Hazlor EVM Chain | Genesis
  - name: "description"
...
The `genesis.json` file defines the initial state of the Hazlor Chain. On top of the standard [tendermint genesis](https://docs.tendermint.com/master/tendermint-core/using-tendermint.html#genesis) format, we customize our own genesis file that includes different [modules](#module_overview) and facilitates the special features of the Hazlor Chain. Sample genesis file can be found [here](https://github.com/crypto-com/testnets/blob/main/testnet-cronos-2/genesis.json).
